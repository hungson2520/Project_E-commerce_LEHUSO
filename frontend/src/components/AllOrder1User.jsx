...
import { orderEdit, orderFetch } from "../features/orderSlice";
...
export default function AllOrder1User() {
          ...
          <Action>
            {auth.isAdmin ? (
              <>
                ...
                <DeliveryButton
                  onClick={() => handleOrderDelivery(params.row.id)}
                >
                  DELIVERY
                </DeliveryButton>
                <ViewButton
